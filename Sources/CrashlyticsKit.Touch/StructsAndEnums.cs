...
namespace Bindings.CrashlyticsKit
{
    static class CFunctions
    {
        ...
        // extern void CLSLogv (NSString * _Nonnull format, va_list ap) __attribute__((format(NSString, 1, 0)));
        [DllImport ("__Internal")]
        ...
        // extern void CLSNSLogv (NSString * _Nonnull format, va_list ap) __attribute__((format(NSString, 1, 0)));
        [DllImport ("__Internal")]
